...
def iluvatar_fp16_application(input, other, output):
    ...
    normal_step = ntl.cast(8192, int_dtype)
    subnormal_step = ntl.cast(8388608, int_dtype)
    step_size = ntl.where(is_subnormal, subnormal_step, normal_step)
...
def iluvatar_bf16_application(input, other, output):
    ...
    # Smallest bf16 positive subnormal is 2^-133 = 0x00000001 in fp32 int.
    zero_result_int = b_sign | one
